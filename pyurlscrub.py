...
page = requests.get(
    "https://www.oslobors.no/ob_eng/Oslo-Boers/Listing/Shares-equity-certificates-and-rights-to-shares/Oslo-Boers-and-Oslo-Axess/Listed-companies-home-state"
)
...
for f in file_items:
    ...
    try:
        ...
        tabula.convert_into(
            ...
            filename + ".csv",
            output_format="csv",
            pages=str(start_page) + "-" + str(num_pages),
        )
        success = True
